        ...
        <div class="row row-sm mg-b-15 mg-t-20 mg-sm-b-20">
            <div class="col-lg-12 col-xl-12">
                <div class="card card-dashboard-six">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h2 class="az-content-title tx-24 mg-b-5 mg-b-lg-8">Add Car Category</h2>
                        </div>
                        <div class="col-sm-6">
                            <a href="{{route('admin.car-type.index')}}" type="buttn" class="btn btn-primary" style="float: right;"><i class="typcn typcn-th-list mg-r-5"></i> View Category List </a>
                        </div>
                    </div>
                    <hr>
                    <form action="{{route('admin.car-type.store')}}" method="POST">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="type" class="form-control" placeholder="Enter Car Category">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-sm-2">
