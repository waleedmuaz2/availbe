          ...
          <ul>
            <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="http://placehold.it/1920x1280" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
              ...
              <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway"
                ...
                style="z-index: 7; white-space: nowrap; font-weight:700;"><span class="text-theme-color-2">20% </span>off
              </div>
          ...
          $(".rev_slider").revolution({
            ...
            navigation: {
              ...
              bullets: {
                ...
                v_offset:30,
                space:5,
                tmp:'<span class="tp-bullet-img-wrap">  <span class="tp-bullet-image"></span></span><span class="tp-bullet-title">eShop</span>'
              }
            },
  ...
  <section>
    <div class="container pt-20 pb-20">
     <div class="esc-heading lr-line left-heading">
       <h4>Top Deals and Offers</h4>
     </div>
     <div class="row">
       <div class="col-md-3">
         <div class="vertical-tab">
           <ul class="nav nav-tabs">
             <li class="active"><a href="#tab01" data-toggle="tab"><b>Deals of The Month</a></b></li>
             <li><a href="#tab02" data-toggle="tab"><b>Free Shippings</a></b></li>
             <li><a href="#tab03" data-toggle="tab"><b>Open Box (Refurbished)</a></b></li>
             <li><a href="#tab04" data-toggle="tab"><b>Refferal Program</a></b></li>
             <li><a href="#tab05" data-toggle="tab"><b>Subscribe & Save 10%</a></b></li>
           </ul>
         </div>
       </div>
       <div class="col-md-9">
         <div class="tab-content">
           <div class="tab-pane fade in active" id="tab01">
             <div class="row">
               <div class="col-md-12">
               <img class="pull-left pr-20" width="300" src="http://placehold.it/155x90" alt="">
          ...
          <div class="products">
                ...
                <div class="product-thumb">
                  ...
                  <div class="overlay">
                    <div class="btn-add-to-cart-wrapper">
                      <a class="btn btn-theme-colored btn-sm btn-flat pl-20 pr-20 btn-add-to-cart text-uppercase font-weight-700" href="{{route('shop-cart')}}" target="_blank">Add To Cart</a>
                    </div>
                    <div class="btn-product-view-details">
                      <a class="btn btn-default btn-theme-colored btn-sm btn-flat pl-20 pr-20 btn-add-to-cart text-uppercase font-weight-700" href="{{route('product-details')}}" target="_blank">View detail</a>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 mb-30">
              <div class="product">
                ...
                <div class="product-details text-center">
                  <a href="#"><h5 class="product-title">Looking Mirror</h5></a>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 mb-30">
              <div class="product">
                ...
                <div class="product-details text-center">
                  <a href="#"><h5 class="product-title">Brand New Tires</h5></a>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 mb-30">
              <div class="product">
                ...
                <div class="product-details text-center">
                  <a href="#"><h5 class="product-title">Intercoolers</h5></a>
      ...
      <div class="row">
        <div class="">
          <div class="col-md-6 text-center">
            <img alt="" src="http://placehold.it/400x350">
          </div>
          <div class="col-md-6 text-left">
            <h4 class="mt-50 text-theme-color-2 mb-0">Big discount!</h5>
            <h1 class="mt-0">New Trendy Products</h1>
            <h4 class="mt-10">Up to 21% off on all products!</h4>
            <a href="#" class="btn btn-theme-colored btn-circled mt-20">Shop now</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="call-to-action pt-30 pb-20">
          ...
          <div class="col-md-9 pl-0">
            <h3 class="mt-5 text-white text-uppercase font-weight-600">All kind of sell get 20% discount in this season with gift!</h3>
          </div>
          <div class="col-md-2 text-right flip sm-text-center">
            <a class="btn btn-default btn-lg btn-circled mt-5" href="#">Shop Now<i class="fa fa-angle-double-right font-16 ml-10"></i></a>
          </div>
        </div>
      </div>
    </div>
