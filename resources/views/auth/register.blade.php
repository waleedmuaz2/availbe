               ...
               <div class="tab-content">
                  <div class="tab-pane fade in active p-15" id="register-tab">
                     <div class="icon-box mb-0 p-0">
                        ...
                        <h4 class="text-gray pt-10 mt-0 mb-30">Don't have an Account? Register as Partners Now.</h4>
                     </div>
                     <hr>
                     <p class="text-gray">Register as a partner using this page then select what category you fall into. You then get access to a profile.</p>
                     @if ($errors->any())
                     ...
                     @endif
                     <form id="reg-form" action="{{route('register')}}" class="form" method="post">
                        {{csrf_field()}}
